...
export class PlayerInfo {
  ...
  get character(): string {
    return this._info.character || this._random_character;
  }
  ...
  get random_character() {
    return this._random_character;
  }
  set random_character(v: string) {
    this.set_random_character(v);
  }

  get is_random() {
    return !this._info.character;
  }
  ...
  get team_decided(): boolean {
    return this._team_decided;
  }
  set team_decided(v: boolean) {
    this.set_team_decided(v);
  }

  get character_decided(): boolean {
    return this._character_decided;
  }
  set character_decided(v: boolean) {
    this.set_character_decided(v);
  }
  ...
  private get storage_key() {
    return "player_info_" + this._info.id;
  }
