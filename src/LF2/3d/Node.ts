...
export default class Node implements INode {
  ...
  get user_data(): Record<string, any> { return this._mesh.userData; }
  ...
  set_visible(v: boolean): this { this._mesh.visible = v; return this; }
  set_name(v: string): this { this._mesh.name = v; return this }
  set_x(x: number): this { this._mesh.position.x = x; return this; }
  set_y(y: number): this { this._mesh.position.y = y; return this; }
  set_z(z: number): this { this._mesh.position.z = z; return this; }
  ...
  get_user_data(key: string) {
    return this._mesh.userData[key]
  }
  add_user_data(key: string, value: any): this {
    this._mesh.userData[key] = value;
    return this;
  }
  del_user_data(key: string): this {
    delete this._mesh.userData[key];
    return this;
  }
  merge_user_data(v: Record<string, any>): this {
    Object.assign(this._mesh.userData, v);
    return this;
  }
