...
export class Loader<T> {
   ...
   * @type {boolean}
   */
  get loading(): boolean { return this._state === 'loading' }
   ...
   * @type {boolean}
   */
  get need_load(): boolean { return this._state === 'clean' }
   ...
   */
  constructor(loader?: () => Promise<T>, on_resolve?: (data: T) => void, on_clear?: () => void) {
    this._loader = loader;
