...
const map: Record<CollisionVal, IValGetter<ICollision>> = {
  [CollisionVal.AttackerType]: (collision: ICollision) =>
    collision.attacker.data.type,
  [CollisionVal.VictimType]: (collision: ICollision) =>
  ...
  [CollisionVal.AttackerState]: (collision: ICollision) =>
    collision.aframe.state,
  [CollisionVal.VictimState]: (collision: ICollision) => collision.bframe.state,
  [CollisionVal.AttackerHasHolder]: (collision: ICollision) =>
    collision.attacker.holder ? 1 : 0,
  [CollisionVal.VictimHasHolder]: (collision: ICollision) =>
    collision.victim.holder ? 1 : 0,
  [CollisionVal.AttackerHasHolding]: (collision: ICollision) =>
    collision.attacker.holding ? 1 : 0,
  [CollisionVal.VictimHasHolding]: (collision: ICollision) =>
    collision.victim.holding ? 1 : 0,
  [CollisionVal.AttackerOID]: (collision: ICollision) =>
    collision.attacker.data.id,
  ...
  [CollisionVal.VictimFrameIndex_ICE]: (collision: ICollision) =>
    collision.victim.data.indexes?.ice,
  [CollisionVal.ItrFall]: (collision: ICollision) => collision.itr.fall,
  [CollisionVal.AttackerThrew]: (collision: ICollision) =>
    collision.attacker.throwinjury !== void 0 ? 1 : 0,
  [CollisionVal.VictimThrew]: (collision: ICollision) =>
    collision.victim.throwinjury !== void 0 ? 1 : 0,
};
